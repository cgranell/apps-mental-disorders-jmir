...
plot_tempdist_stakedbarchart <- 
    data_plot_tempdist %>%
        ...
        #geom_label_repel(aes(x=year, y=number_cases, fill=val_type, label=number_cases)) +
...
cowplot::ggsave2(plot = plot_dist_md, filename = plot_dist_md_file_name, device = "png", 
                 path = here::here("figs"), scale = 1, width = 22, height = 18, units = "cm", dpi = 600)
...
cowplot::ggsave2(plot = kp_bubblechart, filename = kp_file_name, device = "png", 
                 path = here::here("figs"), scale = 1, width = 40, height = 28, units = "cm", dpi = 600)
